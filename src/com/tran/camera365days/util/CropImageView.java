...
import com.tran.camera365days.R;
...
public class CropImageView extends FrameLayout {
    ...
    /**
     * Set invisible for overlay
     */
    public void setInvisibleOverlay() {
    	mCropOverlayView.setVisibility(View.INVISIBLE);
    }
    
    /**
     * Set visible for overlay
     */
    public void setVisibleOverlay() {
    ...
    public void flip(int type) {
        ...
        if (type == FLIP_VERTICAL) {          // if vertical
            // y = y * -1
            matrix.preScale(1.0f, -1.0f);
        } else if (type == FLIP_HORIZONTAL) {  // if horizonal
            // x = x * -1
            matrix.preScale(-1.0f, 1.0f);  
        } else {                               // unknown type
            //nothing
